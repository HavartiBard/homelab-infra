...
# =============================================================================
# Oh My Zsh + zshrc setup
# =============================================================================
# Always refresh .zshrc from skel (managed by image, not user-edited)
...
# =============================================================================
# Write environment variables to user profile for SSH sessions
# =============================================================================
...
# Pass through API keys and settings
for var in OPENROUTER_API_KEY LMSTUDIO_API_KEY LMSTUDIO_BASE_URL OP_SERVICE_ACCOUNT_TOKEN NOTION_MCP_TOKEN CODEX_CONFIG_FILE TZ; do
    if [ -n "${!var}" ]; then
...
# =============================================================================
# Legacy .bashrc support (in case user switches to bash)
# =============================================================================
