...
| mem0-server | 8888 (API), 8889 (dashboard) | LAN-only | Self-hosted Mem0 (FastAPI + pgvector), shared memory backend for Lyra/Raclette, no NPM proxy — see PR [#251](https://code.klsll.com/Homelab/homelab-infra/pulls/251) |
