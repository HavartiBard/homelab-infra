...
| **mem0-server** | 8888 | HTTP | 🔒 LAN-Only | Self-hosted Mem0 API (FastAPI + pgvector), shared by Lyra/Raclette — see PR [#251](https://code.klsll.com/Homelab/homelab-infra/pulls/251) |
